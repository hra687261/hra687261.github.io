...
- *Smt.ml: A Multi-Backend Frontend for SMT Solvers in OCaml* {blob br}[]
  ...
  [Paper](./assets/papers/2026_TACAS.pdf) [HAL](https://inria.hal.science/hal-04761767v2)
  {bib "2026_TACAS"}[]
...
- *Theory of sequences tailored for program verification* {blob br}[]
  *Hichem Rami Ait-El-Hara*. {blob br}[]
  ...
  [Archive](https://theses.fr/2025UPASG067) [Manuscript](./assets/papers/PhD_manuscript.pdf) [Slides](./assets/papers/PhD_defense_slides.pdf) [HAL](https://theses.hal.science/tel-05383515) {page_link Defense}[Defense Page]
  {bib "PhD_manuscript"}[]
...
- *Reasoning over n-Indexed Sequences in SMT* {blob br}[]
  *Hichem Rami Ait-El-Hara*, François Bobot, and Guillaume Bury. {blob br}[]
  ...
  [Paper](./assets/papers/2025_AI.pdf) [Publisher Version](https://link.springer.com/article/10.1007/s00236-025-00496-w)
  {bib "2025_AI"}[]
...
- *Constraint Propagation for Bit-Vectors in Alt-Ergo* {blob br}[]
  *Hichem Rami Ait-El-Hara*, Guillaume Bury, Basile Clément and Pierre Villemot. {blob br}[]
  ...
  [Paper](./assets/papers/2025_SMT.pdf) [Publisher Version](https://ceur-ws.org/Vol-4008/#SMT_paper20)
  {bib "2025_SMT"}[]
...
- *Relational Abstractions Based on Labeled Union-Find* {blob br}[]
  ...
  [Paper](./assets/papers/2025_PLDI.pdf) [HAL](https://hal.science/hal-05029216v1) [Publisher Version](https://dl.acm.org/doi/10.1145/3729298)
  {bib "2025_PLDI"}[]
...
- *An SMT Theory for n-Indexed Sequences* {blob br}[]
  *Hichem Rami Ait-El-Hara*, François Bobot, and Guillaume Bury. {blob br}[]
  ...
  [Paper](./assets/papers/2024_SMT.pdf) [HAL](https://hal.science/hal-04706489) [Publisher Version](https://ceur-ws.org/Vol-3725/#short13)
  {bib "2024_SMT"}[]
...
- *On SMT Theory Design: The Case of Sequences* {blob br}[]
  *Hichem Rami Ait-El-Hara*, François Bobot, and Guillaume Bury. {blob br}[]
  ...
  [Paper](./assets/papers/2024_LPAR.pdf) [HAL](https://hal.science/hal-04706459) [Publisher Version](https://easychair.org/publications/paper/qdvJ)
  {bib "2024_LPAR"}[]
...
- *Alt-Ergo-Fuzz: A fuzzer for the Alt-Ergo SMT solver* {blob br}[]
  *Hichem Rami Ait-El-Hara*, Guillaume Bury, and Steven de Oliveira. {blob br}[]
  ...
  [Paper](./assets/papers/2022_JFLA.pdf) [HAL](https://hal.inria.fr/hal-03626861)
  {bib "2022_JFLA"}[]
